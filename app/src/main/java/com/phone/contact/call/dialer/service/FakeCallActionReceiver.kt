...
import com.phone.contact.call.dialer.ui.features.fakecall.FakeCallActivity
...
class FakeCallActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_ANSWER = "com.phone.contact.call.dialer.FAKE_ACTION_ANSWER"
        const val ACTION_DECLINE = "com.phone.contact.call.dialer.FAKE_ACTION_DECLINE"
    }
}
