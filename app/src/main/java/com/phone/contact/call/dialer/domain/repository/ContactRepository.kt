package com.phone.contact.call.dialer.domain.repository

import android.net.Uri
import com.phone.contact.call.dialer.domain.model.Contact
import com.phone.contact.call.dialer.domain.model.DetailedContact
...
interface ContactRepository {
    ...
    // Recycle Bin
    fun fetchDeletedContacts(): kotlinx.coroutines.flow.Flow<List<com.phone.contact.call.dialer.data.local.entity.DeletedContactEntity>>
